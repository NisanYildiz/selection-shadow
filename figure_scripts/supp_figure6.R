...
ggsave("suppFig6-celltype-diff-conservation.png", plot = supp_fig_5, device = png,
       path = "results_graphs/", type = "cairo",
       scale = 1, units = "cm", width = 42, height = 38, dpi = 300)
ggsave("suppFig6-celltype-diff-conservation.tiff", plot = supp_fig_5, device = "tiff",
       path = "results_graphs/", type = "cairo",
       scale = 1, units = "cm", width = 42, height = 38, dpi = 300)
ggsave("suppFig6-celltype-diff-conservation.pdf", plot = supp_fig_5, device = "pdf",
       path = "results_graphs/", 
       scale = 1, units = "cm", width = 42, height = 38, dpi = 300)
