...
ggsave("suppFig4-dnds-difference-bulk.png", plot = supp_figure3, device = png,
       path = "results_graphs/",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)
ggsave("suppFig4-dnds-difference-bulk.tiff", plot = supp_figure3, device = "tiff",
       path = "results_graphs/", type = "cairo",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)
ggsave("suppFig4-dnds-difference-bulk.pdf", plot = supp_figure3, device = "pdf",
       path = "results_graphs/",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)