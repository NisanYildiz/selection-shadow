...
rho_vals <- data.frame(organism = c("G. gallus", "G. gallus", "N. furzeri", "N. furzeri", 
                       ...
                       type = rep(c("Differentially Expressed Genes", "All Genes")),
...
rho_vals$type = factor(rho_vals$type, levels = c("Differentially Expressed Genes", "All Genes"))
...
figure1 <- genes_cor / rho_barplot + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') &
