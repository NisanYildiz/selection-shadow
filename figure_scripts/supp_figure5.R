...
ggsave("suppFig5-NMR-cons-density.png", plot = NMR_cons_plot, device = png,
       path = "results_graphs/",
       scale = 1, width = 10, height = 12, units = "in", dpi = 300)
ggsave("suppFig5-NMR-cons-density.tiff", plot = NMR_cons_plot, device = "tiff",
       path = "results_graphs/", type = "cairo",
       scale = 1, width = 10, height = 12, units = "in", dpi = 300)
ggsave("suppFig5-NMR-cons-density.pdf", plot = NMR_cons_plot, device = "pdf",
       path = "results_graphs/",
       scale = 1, width = 10, height = 12, units = "in", dpi = 300)
