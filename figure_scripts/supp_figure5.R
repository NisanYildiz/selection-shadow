...
sup_figure5 <- ggplot(data = GSE99791_df, aes(age, results)) +
...
ggsave("suppFig5-astrocyte-hypothalamus-transcriptome-cons-vs-age.png", plot = sup_figure5, device = png,
       path = "results_graphs/",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)
ggsave("suppFig5-astrocyte-hypothalamus-transcriptome-cons-vs-age.tiff", plot = sup_figure5, device = "tiff",
       path = "results_graphs/", type = "cairo",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)
ggsave("suppFig5-astrocyte-hypothalamus-transcriptome-cons-vs-age.pdf", plot = sup_figure5, device = "pdf",
       path = "results_graphs/",
       scale = 1, width = 10, height = 5, units = "in", dpi = 300)
