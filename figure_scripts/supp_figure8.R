...
supp_fig_7 
ggsave("suppFig8-tajimasD.png", plot = supp_fig_7, device = png,
       path = "results_graphs/",
       scale = 1, width = 10, height = 10, units = "in", dpi = 300)
ggsave("suppFig8-tajimasD.tiff", plot = supp_fig_7, device = "tiff",
       path = "results_graphs/", type = "cairo",
       scale = 1, width = 10, height = 10, units = "in", dpi = 300)
ggsave("suppFig8-tajimasD.pdf", plot = supp_fig_7, device = "pdf",
       path = "results_graphs/",
       scale = 1, width = 10, height = 10, units = "in", dpi = 300)
